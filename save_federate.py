...
if __name__ == "__main__":
    ...
    axs[1].plot(xaxis, current_term[:,bran_idx-1], color="tab:red", linestyle="-")
    axs[1].plot(xaxis, current_term[:,bran_num+(bran_idx-1)], color="tab:green", linestyle="-")
    axs[1].plot(xaxis, current_term[:,2*bran_num+(bran_idx-1)], color="tab:blue", linestyle="-")
